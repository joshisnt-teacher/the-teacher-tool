  ...
  public: {
    Tables: {
      ...
      ai_action_results: {
        ...
        Relationships: [
          {
            foreignKeyName: "ai_action_results_task_id_fkey"
            columns: ["task_id"]
            isOneToOne: false
      ...
      exit_ticket_templates: {
        ...
        Relationships: [
          {
            foreignKeyName: "exit_ticket_templates_school_id_fkey"
            columns: ["school_id"]
            isOneToOne: false
      ...
      tasks: {
        Row: {
          ...
          hidden_from_assessments: boolean
          id: string
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "tasks_exit_ticket_template_id_fkey"
            columns: ["exit_ticket_template_id"]
            isOneToOne: false
            referencedRelation: "exit_ticket_templates"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      template_question_options: {
        ...
        Relationships: [
          {
            foreignKeyName: "template_question_options_template_question_id_fkey"
